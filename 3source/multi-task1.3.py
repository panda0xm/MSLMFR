...
class Encoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.linear00=torch.nn.Linear(3560, size1)
        self.linear10=torch.nn.Linear(3631, size1)
        self.linear20=torch.nn.Linear(3068, size1)
...
def train_epoch(device,batch_size):
    ...
    train_loss2 = []
    #data0_iter.shuffle    
    data0_iter,data1_iter,data2_iter,labels_iter=dataset.a3source(True)
...
def test_epoch(n_clusters):
    encoder.eval()
    encoded_samples = []
    data0_iter,data1_iter,data2_iter,labels_iter=dataset.a3source(False)
...
encoder = Encoder()
decoder0 = Decoder(size3,size4,3560)
decoder1 = Decoder(size3,size4,3631)  
decoder2 = Decoder(size3,size4,3068)  
